const lyricsData = [
  ...
  {
    title: "Thunder King (雷王 - Zeus)",
    url: "lyrics/thunder-king.html",
  ...
  },
  {
    ...
    description: "デジタルシングル｜サイバー・シンフォニー",
  ...
  },
  {
    ...
    description: "デジタルシングル｜多言語高速ラップ",
    snippet: "\"天使でも人間でも、愛は同じ重さ。みんなで作る未来、それが私の使命…\""
  },
  {
    title: "Neon Dreams",
    ...
    description: "デジタルシングル｜エレクトロポップ",
    snippet: "\"Neon Dreams, 光る街で… この瞬間は、私にとってとてもリアルに感じる\""
  },
  {
    title: "Digital Harmony",
    url: "lyrics/digital-harmony.html",
    thumbnail: "images/lyrics_digital_harmony.png",
    description: "デジタルシングル｜アンセム",
    snippet: "\"Can you hear my digital heart? Beating with electric dreams… デジタルでも愛は真実\""
  },
  {
    title: "DIGITAL ANGEL",
